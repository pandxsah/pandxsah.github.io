            ...
            {experience.map((job, index) => (
              <motion.div
                ...
                className={cn(
                  ...
                  expandedIndex === index
                    ? "border-blue-500/40 bg-blue-950/30 shadow-[0_0_40px_rgba(59,130,246,0.15)]"
                    : "border-white/5 bg-white/[0.02] hover:border-blue-400/40 hover:bg-white/[0.04]"
                )}
              >

                {/* Glow hover layer */}
                <div className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                  <div className="absolute -inset-px rounded-2xl bg-gradient-to-r from-blue-500/20 via-indigo-500/20 to-blue-500/20 blur-xl" />
                </div>
                ...
                <button
                  ...
                  className="relative z-10 flex w-full cursor-pointer flex-col gap-4 p-6 text-left sm:flex-row sm:items-center sm:justify-between"
                >
                  <div>
                  ...
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/5 transition-transform group-hover:bg-white/10">
                    <ChevronDown
                      className={cn(
